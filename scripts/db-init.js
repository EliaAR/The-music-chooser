...
const createTableSongs =
  "CREATE TABLE songs (id_song INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, id_room INT NOT NULL CONSTRAINT fk_idroom REFERENCES rooms ON DELETE CASCADE, name_song TEXT NOT NULL, url_song TEXT NOT NULL, img TEXT, audio TEXT, expire INT NOT NULL, votos INT DEFAULT 0 )";
